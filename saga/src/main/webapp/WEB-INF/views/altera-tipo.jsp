            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
               <div class="container-fluid">
                  <div class="navbar-wrapper">         
                     <a class="navbar-brand" href="#">Registro de Tipos de Atendimento</a>
                  </div>
               </div>
            </nav>
            <!-- End Navbar -->
            ...
            <div class="content">
               <div class="card">
                  <div class="card-header">
                     <h5 class="title">Detalhes da Tipo</h5>
                  </div>
                  <div class="card-body">
                     <form action="alterar-tipo" method="post">
                     <input type="text" value="${tipo.codigoTipoAtendimento}" name="codigoTipoAtendimento" hidden="true">
                        <fieldset>
                           <legend>Dados do Tipo de Atendimento</legend>
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label for="nome">Nome do Tipo</label>
                                    <input type="text" readonly="readonly" id="nome" name="nomeTipoAtendimento" maxlength="255" required="required" class="form-control" value="${tipo.nomeTipoAtendimento}"  placeholder="Ex.: Violência Doméstica">
                                 </div>
                              </div>
                              </div>
                              </fieldset>
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                <button type="button" id="alterar" onclick="habilitar()" class="form-control btn btn-info"><span id="container">Alterar Tipo de Atendimento</span>&nbsp;<i class="now-ui-icons ui-1_check"></i></button>
