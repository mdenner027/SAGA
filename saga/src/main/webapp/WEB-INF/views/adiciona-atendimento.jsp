...
<html lang="pt-br" class="">
   <head>
      ...
      <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/38/11/intl/pt_br/util.js"></script>
  		...
  		<script>
  			function cadastrar(){
				document.getElementById("cadastrarDiscente").hidden = false;
				document.getElementById("cadastrarOuEscolher").hidden = true;
				document.getElementById("matricula1").disabled = true;
				
  	  	  	}

  			function naoCadastrar(){
				document.getElementById("escolherDiscente").hidden = false;
				document.getElementById("cadastrarOuEscolher").hidden = true;
				document.getElementById("matriculaD").value = 0;
            ...
            <div class="content">
               <div class="card">
                  <div class="card-header">
                     <h5 class="title">Registrar Atendimento</h5>
                  </div>
                  <div class="card-body">
                     <form id="formulario" method="post" action="adiciona-atendimento">
                     <fieldset id="cadastrarOuEscolher">
                     		<legend class="d-flex justify-content-center">Deseja cadastrar um novo discente?</legend>
                     		<div class="row">
                        	<div class="col-md-6">
                              <div class="form-group">
                                 <a>                                 	
                                	 <button type="button" id="yes" onclick="cadastrar();" class="form-control btn btn-warning"><b>SIM!</b></button>
                              	</a>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 <a>
									<button type="button" id="no" onclick="naoCadastrar();" class="form-control btn btn-warning"><b>NÃO!</b></button>
                              	</a>
                              </div>
                           </div>
                           </div>
                     	</fieldset>
                     	<fieldset id="escolherDiscente" hidden="true">
                     		<legend>Escolher discente</legend>
                     		<div class="col-md-12 pl-1">
                                 <div class="form-group">
                                    <label for="codigo">Discente</label>
                                    <select name="codigo" id="codigo" class="form-control">
                                       <c:forEach var="discente" items="${discentes}">
                                       		<option value="${discente.codigoDiscente}">${discente.nomeDiscente}</option>
                                       </c:forEach>
                                    </select>
                                 </div>
                              </div>
                     	</fieldset>
                     <input type="text" name="coletivoAtendimento" id="coletivo" value="0" hidden="true">
                        <fieldset id = "cadastrarDiscente" hidden="true">
                           <legend>Informações do Discente</legend>
                           <div class="row">
                              <div class="col-md-6 pr-1">
                                 <div class="form-group">
                                    <label for="nome">Nome do Discente</label>
                                    <input type="text"  id="nome" name="discenteAtendimento.nomeDiscente" class="form-control" placeholder="Ex.: João Costa Figuereido">
                                 </div>
                              </div>
                              <div class="col-md-2 pl-1 pr-1">
                                 <div class="form-group">
                                    <label for="matriculaD">Matrícula</label>
                                    <input type="text" id="matriculaD" name="discenteAtendimento.matriculaDiscente" class="form-control" maxlength="10" placeholder="Ex.: 2016010800">
                                 </div>
                              </div>
                              <div class="col-md-4 pl-1">
                                 <div class="form-group">
                                    <label for="curso">Curso</label>
                                    <select name="discenteAtendimento.cursoDiscente.codigoCurso" id="curso" class="form-control">
                           ...
                           <div class="row">
                              <div class="col-md-3 pr-1">
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="rua" name="discenteAtendimento.ruaDiscente" class="form-control" placeholder="Ex.: João Barbosa Figuereido">
                                 </div>
                              </div>
                              <div class="col-md-3 pl-1 pr-1">
                                 <div class="form-group">
                                    <label for="bairro">Bairro</label>
                                    <input id="bairro" type="text" class="form-control" name="discenteAtendimento.bairroDiscente" placeholder="Ex.: Centro">
                                 </div>
                              </div>
                              <div class="col-2 pl-1 pr-1">
                                 <div class="form-group">
                                    <label for="numero">Número</label>
                                    <input id="numero" type="text" name="discenteAtendimento.numeroResidenciaDiscente" class="form-control" placeholder="Ex.: 22A">
                                 </div>
                              </div>
                              <div class="col-4 pl-1">
                                 <div class="form-group">
                                    <label for="cidade">Cidade</label>
                                    <input id="cidade" type="text" name="discenteAtendimento.cidadeDiscente" class="form-control" placeholder="Ex.: Angicos">
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                              <div class="col-3 pr-1">
                                 <div class="form-group">
                                    ...
                                    <input id="contato" maxlength="15" type="text" name="discenteAtendimento.telefoneDiscente" class="form-control" placeholder="Ex.: 9962744110">
                                 </div>
                              </div>
                           </div>
                        </fieldset>
                           ...
                           <div class="row">
                              <div class="col-md-4 pr-1">
                                 <div class="form-group">
                                    ...
                                    <select id="tipo" name="tipoAtendimento.codigoTipoAtendimento" class="form-control">
                              ...
                              <div class="col-md-4 pl-1 pr-1">
                                 <div class="form-group">
                                    ...
                                    <select id="demanda" class="form-control" name="demandaAtendimento.codigoDemandaAtendimento">
                              ...
                              <div class="col-md-4 pl-1">
                                 <div class="form-group">
                                    <label for="encaminhamento">Encaminhamentos</label>
                                    <select id="encaminhamento" class="form-control" name="encaminhamentoAtendimento.codigoEncaminhamento">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <a href="atendimentos-registrados"><button type="button" class="btn btn-primary form-control"><i class="now-ui-icons arrows-1_minimal-left"></i>&nbsp; Voltar
                                 </button></a>
                              </div>
                           </div>
                           <div class="col-md-6">
