   ...
   <body class="">
      <div class="wrapper ">
         <div class="sidebar" data-color="green">
            ...
            <script>
				window.onload = ativaMenu("demandas");
			</script>
            </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
               <div class="container-fluid">
                  <div class="navbar-wrapper">         
                     <a class="navbar-brand" href="#">Registro de Demandas de Atendimento</a>
                  </div>
               </div>
            </nav>
            <!-- End Navbar -->
        ...
        <div class="row">
          ...
          <div class="card">
          	<div class="card-header">
            	<h4 class="card-title">Registrar Demanda</h4>
            </div>
            <div class="card-body">
            	<div class="col-md-12">
             		<form action="registrar-demanda" method="post">
             			<button title="Registrar Demanda" type="submit" class="btn btn-info btn-block redondo">
             			Registrar nova demanda &nbsp; <i class="now-ui-icons ui-1_simple-add"></i>
             			</button>
             		</form>
             	</div>
             </div>
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Demandas Registradas</h4>
              </div>
              <div class="card-body">
                <div class="table table-hover table-responsive">
                  <table class="table fonte-reduzida">
                    ...
                    <tbody>
                      <c:forEach var="d" items="${demandas}">
                      		<tr>
                      			<td>
                      				${d.nomeDemandaAtendimento}
                      			</td>
                      			<td>
                      				<form class="form-text" action="exibir-demanda-de-atendimento" method="post">
                      					<input type="text" value="${d.codigoDemandaAtendimento}" name="codigoDemandaAtendimento" hidden="true">
                      					<button type="submit" class="btn btn-success form-control"><i class="now-ui-icons arrows-1_minimal-right"></i></button>
                      				</form>
                      			</td>
                      			<td>
                      				<form class="form-text" action="excluir-demanda" method="post">
                      					<input type="text" value="${d.codigoDemandaAtendimento}" name="codigoDemandaAtendimento" hidden="true">
