   ...
   <head>
  	...
  	<script>
			function habilitar() {
				...
				document.getElementById("encaminhamento").readOnly = false;
            ...
            <div class="content">
               <div class="card">
                  <div class="card-header">
                     <h5 class="title">Detalhes do Atendimento ${atendimento.codigoAtendimento}</h5>
                  </div>
                  <div class="card-body">
	                           ...
	                           <div class="row">
	                              <div class="col-md-4 pr-1">
	                                 <div class="form-group">
	                                    ...
	                                    <select disabled="disabled" id="tipo" name="codigoTipoAtendimento" class="form-control">
	                              ...
	                              <div class="col-md-4 pl-1 pr-1">
	                                 <div class="form-group">
	                                    ...
	                                    <select id="demanda" disabled="disabled" name="codigoDemandaAtendimento" class="form-control">
	                              ...
	                              <div class="col-md-4 pl-1">
	                                 <div class="form-group">
	                                    ...
	                                    <input readonly="readonly" type="text" id="encaminhamento"  value="${atendimento.encaminhamentoAtendimento}" class="form-control" name="encaminhamentoAtendimento">
	                                 </div>
	                              </div>
	                           </div>
	                        </fieldset>
