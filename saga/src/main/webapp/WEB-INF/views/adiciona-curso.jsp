            ...
            <div class="content">
               <div class="card">
                  <div class="card-header">
                     <h5 class="title">Registrar Curso</h5>
                  </div>
                  <div class="card-body">
                     <form action="adiciona-curso" method="post">
                        <fieldset>
                           <legend>Dados do Curso</legend>
                           <div class="row">
                              <div class="col-md-3 pr-1">
                                 <div class="form-group">
                                    <label for="codigoCurso">Codigo e-Mec</label>
                                    <input type="text" value="${curso.cursoCodigo}" required="required" id="codigoCurso" name="codigoCurso" class="form-control" maxlength="7" placeholder="Ex.: 1122334">
                                 </div>
                              </div>
                              <div class="col-md-9">
                                 <div class="form-group">
                                    <label for="nome">Nome do curso</label>
                                    <input type="text" id="nome" name="nomeCurso" maxlength="255" required="required" class="form-control" value="${curso.cursoNome}"  placeholder="Ex.: Ciência e Tecnologia">
                                 </div>
                              </div>
                              </div>
                              </fieldset>
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <button type="submit" class="form-control btn btn-success">Registrar Curso&nbsp;<i class="now-ui-icons ui-1_check"></i></button>
                              </div>
                           </div>
                        </div>
                     </form>
