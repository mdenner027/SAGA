   ...
   <body class="">
      <div class="wrapper ">
         <div class="sidebar" data-color="green">
            ...
            <script>
				window.onload = ativaMenu("encaminhamentos");
			</script>
            </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
               <div class="container-fluid">
                  <div class="navbar-wrapper">         
                     <a class="navbar-brand" href="#">Registro de Encaminhamentos</a>
                  </div>
               </div>
            </nav>
            <!-- End Navbar -->
            ...
            <div class="content">
               <div class="card">
                  <div class="card-header">
                     <h5 class="title">Detalhes do Encaminhamento</h5>
                  </div>
                  <div class="card-body">
                     <form action="altera-encaminhamento" method="post">
                     <input type="text" value="${encaminhamento.codigoEncaminhamento}" name="codigoEncaminhamento" hidden="true">
                        <fieldset>
                           <legend>Dados do Encaminhamento</legend>
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label for="nome">Descrição do Encaminhamento</label>
                                    <input type="text" readonly="readonly" id="nome" name="descricaoEncaminhamento" maxlength="255" required="required" class="form-control" value="${encaminhamento.descricaoEncaminhamento}"  placeholder="Ex.: Encaminhamento Interinstitucional">
                                 </div>
                              </div>
                              </div>
                              </fieldset>
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                <button type="button" id="alterar" onclick="habilitar()" class="form-control btn btn-info"><span id="container">Alterar Encaminhamento</span>&nbsp;<i class="now-ui-icons ui-1_check"></i></button>
