                  ...
                  <div class="card-body">
                     ...
                     <input type="text" name="mvc" value="AdicionaAtendimentoLogica" hidden="true">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <a href="controller?mvc=ListaAtendimentosLogica"><button type="button" class="btn btn-primary form-control"><i class="now-ui-icons arrows-1_minimal-left"></i>&nbsp; Voltar
                                 </button></a>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                              	<a href="controller?mvc=ExibeAlteraDiscenteLogica&codigo=${discente.matriculaDiscente}">
