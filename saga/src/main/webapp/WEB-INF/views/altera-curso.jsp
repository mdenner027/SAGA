            ...
            <div class="content">
               <div class="card">
                  <div class="card-header">
                     <h5 class="title">Detalhes do Curso</h5>
                  </div>
                  <div class="card-body">
                     <form action="altera-curso" method="post">
                     <input type="text" value="${curso.codigoCurso}" name="codAntigo" hidden="true">
                        <fieldset>
                           <legend>Dados do Curso</legend>
                           <div class="row">
                              <div class="col-md-3 pr-1">
                                 <div class="form-group">
                                    <label for="codigo">Codigo e-Mec</label>
                                    <input type="text" readonly="readonly" value="${curso.codigoCurso}" required="required" id="codigo" name="codigoCurso" class="form-control" maxlength="7" placeholder="Ex.: 1122334">
                                 </div>
                              </div>
                              <div class="col-md-9">
                                 <div class="form-group">
                                    <label for="nome">Nome do curso</label>
                                    <input type="text" readonly="readonly" id="nome" name="nomeCurso" maxlength="255" required="required" class="form-control" value="${curso.nomeCurso}"  placeholder="Ex.: Ciência e Tecnologia">
                                 </div>
                              </div>
                              </div>
                              </fieldset>
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                <button type="button" id="alterar" onclick="habilitar()" class="form-control btn btn-info"><span id="container">Alterar Curso </span>&nbsp;<i class="now-ui-icons ui-1_check"></i></button>
