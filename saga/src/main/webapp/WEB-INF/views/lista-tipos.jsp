        ...
        <div class="row">
          ...
          <div class="card">
          	<div class="card-header">
            	<h4 class="card-title">Registrar Tipo de Atendimento</h4>
            </div>
            <div class="card-body">
            	<div class="col-md-12">
             		<form action="cadastrar-tipo-de-atendimento" method="post">
             			<button title="Registrar Discente" type="submit" class="btn btn-info btn-block redondo">
             			Registrar novo tipo de tipo de atendimento &nbsp; <i class="now-ui-icons ui-1_simple-add"></i>
             			</button>
             		</form>
             	</div>
             </div>
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Tipos de Atendimento Registrados</h4>
              </div>
              <div class="card-body">
                <div class="table table-hover table-responsive">
                  <table class="table fonte-reduzida">
                    <thead class="text-primary">
                      <tr>
                      <th>
                        <b>Nome do Tipo de Atendimento</b>
                      </th>
                      <th>
                    ...
                    <tbody>
                      <c:forEach var="tipo" items="${tipos}">
                      		<tr>
                      			<td>${tipo.nomeTipoAtendimento}</td>
                      			<td>
                      				<form class="form-text" action="exibir-tipo-de-atendimento" method="post">
                      			...
                      			<td>
                      				<form class="form-text" action="excluir-tipo" method="post">
                      					<input type="text" value="${tipo.codigoTipoAtendimento}" name="codigoTipoAtendimento" hidden="true">
