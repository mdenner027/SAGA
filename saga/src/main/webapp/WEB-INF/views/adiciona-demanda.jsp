            ...
            <div class="content">
               <div class="card">
                  <div class="card-header">
                     <h5 class="title">Registrar Demanda</h5>
                  </div>
                  <div class="card-body">
                     <form action="adiciona-demanda" method="post">
                        <fieldset>
                           <legend>Dados da Damanda</legend>
                           <div class="row">
                              <div class="col-md-12 pr-1">
                                 <div class="form-group">
                                    <label for="codigoCurso">Nome da demanda</label>
                                    <input type="text" required="required" id="nomeDemanda" name="nomeDemandaAtendimento" class="form-control" maxlength="255" placeholder="Ex.: Violência Doméstica">
                                 </div>
                              </div>
                              </div>
                              </fieldset>
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <button type="submit" class="form-control btn btn-success">Registrar demanda&nbsp;<i class="now-ui-icons ui-1_check"></i></button>
                              </div>
                           </div>
                        </div>
                     </form>
