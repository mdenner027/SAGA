   ...
   <body class="">
      <div class="wrapper ">
         <div class="sidebar" data-color="green">
            ...
            <script>
				window.onload = ativaMenu("cursos");
			</script>
            </div>
            ...
            <div class="card-body">
            	<div class="col-md-12">
             		<form action="registrar-curso" method="post">
             			...
             			Registrar novo curso &nbsp; <i class="now-ui-icons ui-1_simple-add"></i>
             			</button>
             		</form>
             	</div>
             </div>
                      		...
                      		<tr>
                      			...
                      			<td>
                      				<form class="form-text" action="exibir-curso" method="post">
                      					<input type="text" value="${c.codigoCurso}" name="codigoCurso" hidden="true">
