        ...
        <div class="row">
          ...
          <div class="card">
          	<div class="card-header">
            	<h4 class="card-title">Registrar Discente</h4>
            </div>
            <div class="card-body">
            	<div class="col-md-12">
             		<form action="registrar-discente" method="post">
             			<button title="Registrar Discente" type="submit" class="btn btn-info btn-block redondo">
             				Registrar Discente &nbsp; <i class="now-ui-icons ui-1_simple-add"></i>
             			</button>
             		</form>
             	</div>
             </div>
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Discentes Registrados</h4>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                      <c:forEach var="d" items="${discentes}">
                      		<tr>
                      			...
                      			<td>                      
                      				${d.cursoDiscente.nomeCurso} 
                      			</td>
                      			<td>
                      				<form class="form-text" action="exibir-discente" method="post">
                      					<input type="text" value="${d.codigoDiscente}" name="codigoDiscente" hidden="true">
                      					<button type="submit" class="btn btn-success form-control"><i class="now-ui-icons arrows-1_minimal-right"></i></button>
                      				</form>
                      			</td>
                      			<td>
                      				<form class="form-text" action="excluir-discente" method="post">
                      					<input type="text" value="${d.matriculaDiscente}" name="matriculaDiscente" hidden="true">
