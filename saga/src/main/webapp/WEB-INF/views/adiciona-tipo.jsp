            ...
            <div class="content">
               <div class="card">
                  <div class="card-header">
                     <h5 class="title">Registrar Tipo de Atendimento</h5>
                  </div>
                  <div class="card-body">
                     <form action="adicionar-tipo" method="post">
                        <fieldset>
                           <legend>Dados do Tipo de Atendimento</legend>
                           <div class="row">
                              <div class="col-md-12 pr-1">
                                 <div class="form-group">
                                    <label for="tipo">Nome do Tipo de Atendimento</label>
                                    <input type="text" required="required" id="tipo" name="nomeTipoAtendimento" class="form-control" maxlength="255" placeholder="Ex.: Atendimento Psicossocial">
                                 </div>
                              </div>
                              </div>
                              </fieldset>
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <button type="submit" class="form-control btn btn-success">Registrar Tipo de Atendimento&nbsp;<i class="now-ui-icons ui-1_check"></i></button>
                              </div>
                           </div>
                        </div>
                     </form>
