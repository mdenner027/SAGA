            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
               <div class="container-fluid">
                  <div class="navbar-wrapper">         
                     <a class="navbar-brand" href="#">Registro de Enchaminhamentos</a>
                  </div>
               </div>
            </nav>
            <!-- End Navbar -->
            ...
            <div class="content">
               <div class="card">
                  <div class="card-header">
                     <h5 class="title">Registrar Encaminhamento</h5>
                  </div>
                  <div class="card-body">
                     <form action="adiciona-encaminhamento" method="post">
                        <fieldset>
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="nome" name="descricaoEncaminhamento" maxlength="255" required="required" class="form-control" placeholder="Ex.: Encaminhamento Interinstitucional">
                                 </div>
                              </div>
                              </div>
                              </fieldset>
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <button type="submit" class="form-control btn btn-success">Registrar Encaminhamento&nbsp;<i class="now-ui-icons ui-1_check"></i></button>
                              </div>
                           </div>
                        </div>
                     </form>
