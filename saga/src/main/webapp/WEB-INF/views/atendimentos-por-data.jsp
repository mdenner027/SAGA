          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <br/>
                <h6 class="card-title">Data: <fmt:formatDate value="${data.time}" pattern="dd/MM/yyyy"/></h6>
              </div>
              <div class="card-body">
                      		...
                      		<tr>
                      			<td>
		                      		<span class="text-dark">
		                      			${a.discenteAtendimento.nomeDiscente}
		                      		</span>
                      			</td>
                      			<td>
                      			...
                      			<td>
                      				<span class="text-dark">${a.demandaAtendimento.nomeDemandaAtendimento}</span>
                      			</td>
                      			<td>
                      				<span class="text-dark">${a.tipoAtendimento.nomeTipoAtendimento}</span>
                      			</td>
                      			<td>
                      			...
                      			<td>
                      				<form class="form-text" action="excluir-atendimento" method="post">
                      					<input type="text" value="${a.codigoAtendimento}" name="codigoAtendimento" hidden="true">
