            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
               <div class="container-fluid">
                  <div class="navbar-wrapper">         
                     <a class="navbar-brand" href="#">Registro de Tipos</a>
                  </div>
               </div>
            </nav>
            <!-- End Navbar -->
        ...
        <div class="row">
          ...
          <div class="card">
          	<div class="card-header">
            	<h4 class="card-title">Registrar Encaminhamento</h4>
            </div>
            <div class="card-body">
            	<div class="col-md-12">
             		<form action="cadastrar-encaminhamento" method="post">
             			<button title="Registrar Discente" type="submit" class="btn btn-info btn-block redondo">
             			Registrar novo encaminhamento &nbsp; <i class="now-ui-icons ui-1_simple-add"></i>
             			</button>
             		</form>
             	</div>
             </div>
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Encaminhamentos Registrados</h4>
              </div>
              <div class="card-body">
                  ...
                  <table class="table fonte-reduzida">
                    ...
                    <tbody>
                      <c:forEach var="encaminhamento" items="${encaminhamentos}">
                      		<tr>
                      			<td>${encaminhamento.descricaoEncaminhamento}</td>
                      			<td>
                      				<form class="form-text" action="exibir-encaminhamento" method="post">
                      			...
                      			<td>
                      				<form class="form-text" action="excluir-encaminhamento" method="post">
                      					<input type="text" value="${encaminhamento.codigoEncaminhamento}" name="codigoEncaminhamento" hidden="true">
