...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            ...
            <a href="inicio"><h1>SAGA</h1></a>
            <span class="splash-description">Sistema Auxiliar de Gerenciamento de Atendimentos.</span>
            <h6 style="color:red">Usuário ou Senha inválidos!</h6>
            </div>
